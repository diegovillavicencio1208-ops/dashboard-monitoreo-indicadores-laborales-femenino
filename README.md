...
## Objetivo
Transformar información estadística pública en una herramienta interactiva que facilite el seguimiento de indicadores laborales y apoye el análisis de distintos grupos poblacionales.

---

## Dashboard

🔗[Ver dashboard interactivo en Power BI](https://app.powerbi.com/view?r=eyJrIjoiMjdiMmZjOGItYjE4MS00M2E2LWEwN2ItYzI4YTA3NDRlNThjIiwidCI6IjU1N2NiNjMxLWI3ZjQtNGM1NC1hNjljLWM4MzQ1NWQxMzEyOCIsImMiOjR9&pageName=5a13ee042a084f76b50a)

![Dashboard Mercado Laboral Femenino](https://github.com/diegovillavicencio1208-ops/dashboard-monitoreo-indicadores-laborales-femenino/blob/24f6b270cdc6de5ef9785d5eab92d3efc728b3fc/Imagenes/Ecos_dashboard.png.png)
...
## Características
- Indicadores laborales (KPIs)
- Segmentación por provincia, región y Ecuador
- Filtros dinámicos
- Comparación por variables sociodemográficas
- Navegación mediante botones
- Matriz de análisis interactiva
